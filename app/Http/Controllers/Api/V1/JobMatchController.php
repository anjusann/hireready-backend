...
class JobMatchController extends BaseController
{
    ...
    public function match(Request $request): JsonResponse
    {
        ...
        $result = $this->gemini->matchResumeWithJob(
            $resume->extracted_text,
            $request->job_description
        );

        return $this->successResponse($result, 'Job match completed successfully.');
    }
}